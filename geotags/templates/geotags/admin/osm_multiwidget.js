...
{{ module }}.write_wkt = function(feat){
  ...
  document.getElementById(catchallId).value = {{ module }}.get_ewkt(feat);
}
...
{{ module }}.clearFeatures = function (){
  ...
  document.getElementById(catchallId).value = '';
...
{{ module }}.init = function(){
    //set catchall field to current element field
    //document.getElementById(catchallId).value = document.getElementById('{{ id }}').value;
...
{% endfor %}{% endautoescape %}    };{% endblock %}
    ...
    var wkt = document.getElementById(catchallId).value;
    if (wkt){
